...
![Hide an element](/assets/tips/hide-element.png)

If you're a fan of using the shortcut, then pressing the <kbd>h</kbd> key has the same effect.

<video loop muted controls>
    <source src="/assets/tips/hide-element.mp4" type="video/mp4" />
</video>
...
> Setting `display: none`, `opacity: 0`, and `visibility: hidden` are the common ways to hide an element with CSS. If you want to see the differences between them, take a look at this [post](https://phuoc.ng/collection/this-vs-that/display-none-vs-opacity-0-vs-visibility-hidden/)
