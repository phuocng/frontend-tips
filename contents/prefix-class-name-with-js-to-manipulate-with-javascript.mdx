...
If the answer is not, then you can visit the [GitHub repository](https://github.com/phuocng) and see the source of generated HTML. There are bunch of elements whose class are prefixed with `js-` such as:
