---
category: Practice
cover: /assets/tips/use-documentfragments.png
created: '2021-04-28'
tags: DOM, JavaScript
title: Use DocumentFragments when adding a big list of elements
---

We often use the `appendChild` method to [add a new element](https://phuoc.ng/collection/html-dom/append-to-an-element/) to a given element:
