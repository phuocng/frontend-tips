...
You can invoke any [DOM APIs](https://phuoc.ng/collection/html-dom) from `$0`.

![Access selected node](/assets/tips/selected-node.png)
...
![Store selected node](/assets/tips/store-selected-node.png)
