...
Let's say that we want to calculate the number of [difference days](https://phuoc.ng/collection/1-loc/calculate-the-number-of-difference-days-between-two-dates) between two given dates.
...
-   [Do not use magic numbers when manipulating strings](https://phuoc.ng/collection/tips/do-not-use-magic-numbers-when-manipulating-strings)
