...
This leads to a requirement of building a function that [accepts only the first parameter](https://phuoc.ng/collection/1-loc/create-a-function-that-accepts-a-single-argument/), and ignore the remaining parameters.
