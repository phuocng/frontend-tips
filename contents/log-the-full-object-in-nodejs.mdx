...
It's also possible to use the same technique mentioned in the [_Pretty format JSON_](https://phuoc.ng/collection/tips/pretty-format-json) tip which works in both NodeJS and browser environments.
