...
If you would like to check for the value of attribute, it takes more steps. The sample code below determines whether the [native date input](https://phuoc.ng/collection/html-dom/check-if-the-native-date-input-is-supported/) is supported:
