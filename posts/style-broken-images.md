...
When the image is not found, the `:before` and `:after` elements are displayed as long as they have content. We can take this advantage to make these elements visible to the user.
